...
from ....utils.data.rl_utils import ensure_tensordict, safe_td_copy
...
class Baseline(nn.Module, ABC):
    ...
    def unwrap_dataset(self, dataset: Any) -> Any:
        ...
        from ....utils.data.datasets import BaselineDataset
...
class RolloutBaseline(Baseline):
    ...
    def _rollout_dataset(self, policy: nn.Module, dataset: Any, env: Optional[Any] = None) -> torch.Tensor:
        ...
        from ....utils.data.datasets import tensordict_collate_fn
    ...
    def eval(self, td: TensorDict, reward: torch.Tensor, env: Optional[Any] = None) -> torch.Tensor:  # type: ignore[override]
        ...
        if self.baseline_policy is not None:
            ...
            with torch.no_grad():
                from ....utils.data.rl_utils import ensure_tensordict
